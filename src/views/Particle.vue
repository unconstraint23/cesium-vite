...
onMounted(() => {
  ...
  const texture = textureLoader.load("/src/assets/imgs/10.png");
  const texture1 = textureLoader.load("/src/assets/imgs/9.png");
  const texture2 = textureLoader.load("/src/assets/imgs/11.png");
