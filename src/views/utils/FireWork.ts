...
import fireworksFragment from "../../shader/firework/fragment.glsl";
import fireworksVertex from "../../shader/firework/vertex.glsl";
...
export default class FireWork {
    ...
    private startPoint
    private clock
    private fireworkGeometry
    private FireworksCount
    private fireworksMaterial
    private fireworks
    private scene: any
    private linstener
    private linstener1
    private sendSound
    private sound
    private sendSoundplay: any
    private play: any
    constructor(color: string, to: any, from: any = {x: 0, y: 0, z: 0}) {
    ...
    audioLoader.load(
      `/src/assets/audio/pow${Math.floor(Math.random() * 4) + 1}.ogg`,
      (buffer: any) => {
